<div :class="{'dark text-white-dark' : $store.app.semidark}">
        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    ...
                    <span
                        class="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle lg:inline dark:text-white-light">File Uploader</span>
                </a>
                <a href="javascript:;"
  ...
  color: rgb(14 23 38 / var(--tw-text-opacity));"
                        ...
                        <li class="nav-item">
                            <a
                            <a <?php if (isset($_GET['lists_uploaded']) && $_GET['lists_uploaded'] = 'ok') {
                                ?>
                                style=" background-color: rgb(0 0 0 / 0.08);
  --tw-text-opacity: 1;
  color: rgb(14 23 38 / var(--tw-text-opacity));"
                                ...
                                href="./uploaded-files.php?lists_uploaded=ok" class="group">
                                <div class="flex items-center">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark"> uploaded Files</span>
                                </div>
                            </a>
                        </li>
                        <li class="nav-item">
  ...
  color: rgb(14 23 38 / var(--tw-text-opacity));"
                                <?php
                            } ?> href="./upload-file.php?upload=ok" class="group">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary shrink-0" width="20" height="20"
                                         viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <span
                                        class="ltr:pl-3 rtl:pr-3 text-black dark:text-[#506690] dark:group-hover:text-white-dark">Upload File</span>
                                </div>
                            </a>
                        </li>
